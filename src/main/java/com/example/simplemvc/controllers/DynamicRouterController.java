...
public class DynamicRouterController {
  ...
  @GetMapping({"/",""})
  public String home(){ return "tienda/home"; }
  ...
  public String dynamic(@PathVariable String p1,
    ...
    if (exists("classpath:/templates/" + tpl + ".html")) return tpl;
    if (admin && exists("classpath:/templates/admin/index.html")) return "admin/index";
  ...
  private String build(String p1,String p2,String p3){
    ...
    if(p1!=null) sb.append(p1);
    if(p2!=null) sb.append("/").append(p2);
    if(p3!=null) sb.append("/").append(p3);
    return sb.toString().replaceAll("/+$","");
  }
  private boolean exists(String loc){
    try{ Resource r = loader.getResource(loc); return r!=null && r.exists(); }catch(Exception e){ return false; }
  }
}
