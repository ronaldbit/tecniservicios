...
public class ExcelController {
    ...
    /**
     * Endpoint para generar un reporte de TODOS los usuarios.
     * Llama a JPA, obtiene la lista y la pasa al servicio de Excel.
     */
    ...
    @GetMapping("/reporte/usuarios/{rol}")
    public void generarReporteUsuariosPorRol(
        ...
        // Buscamos con el método personalizado del repo
        List<Usuario> listaFiltrada = usuarioRepository.findByRol(rol);
