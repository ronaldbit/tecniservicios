...
public class CaptchaFilter extends OncePerRequestFilter {
  ...
  protected void doFilterInternal(@NonNull HttpServletRequest req, @NonNull HttpServletResponse resp,
    ...
    if (!(METHOD.equalsIgnoreCase(req.getMethod()) && "/api/auth/login".equals(req.getServletPath()))) {
     ...
     * resp.sendRedirect("/admin/login?error=captcha");
     * else
     * resp.sendRedirect("/auth/login?error=captcha");
     * return;
     * }
     */
