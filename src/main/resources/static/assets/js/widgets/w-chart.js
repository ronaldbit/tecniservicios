...
function floatchart() {
  (function () {
    ...
    */
    ...
    var chart = new ApexCharts(
      document.querySelector("#new-orders-graph"),
      options9
    );
    chart.render();
    var options10 = {
    ...
    var chart = new ApexCharts(
      document.querySelector("#new-users-graph"),
      options10
    );
    chart.render();
    var options11 = {
    ...
    var chart = new ApexCharts(
      document.querySelector("#visitors-graph"),
      options11
    );
    chart.render();
    var options12 = {
    ...
    var chart1 = new ApexCharts(
      document.querySelector("#overview-chart-3"),
      options12
    );
    chart1.render();
    var options13 = {
    ...
    chart.render();
    var chart1 = new ApexCharts(
      document.querySelector("#overview-chart-4"),
      options13
    );
    chart1.render();
    var options14 = {
    ...
    var chart = new ApexCharts(
      document.querySelector("#income-graph"),
      options14
    );
    chart.render();
    var options15 = {
      ...
      series: [
        {
          data: [
            100, 140, 100, 250, 115, 125, 90, 100, 140, 100, 230, 115, 215, 90,
            190, 100, 120, 180,
          ],
        },
      ],
    ...
    var chart = new ApexCharts(
      document.querySelector("#languages-graph"),
      options15
    );
    chart.render();
    var options16 = {
    ...
    var chart = new ApexCharts(
      document.querySelector("#overview-product-graph"),
      options16
    );
    chart.render();
    var options17 = {
